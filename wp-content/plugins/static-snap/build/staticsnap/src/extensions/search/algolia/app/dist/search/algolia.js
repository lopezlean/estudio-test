...
var Algolia = /** @class */ (function () {
    ...
    Algolia.prototype.search = function (query) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var locale, has_translations, params, multipleQueries, error_1, message;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        locale = this.frontend.config().locale || null;
                        has_translations = this.frontend.config().has_translations || false;
                        params = {};
                        if (has_translations) {
                            params.facetFilters = ["language:".concat(locale)];
                        }
                        multipleQueries = [
                            {
