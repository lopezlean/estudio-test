...
const projectURL = 'https://lopezlean.github.io/estudio-test/:8000';
...
const componentStyleDestination = './components/';
...
const watchCompomentStyles = ['./components/**/*.scss'];
...
const textDomain = 'gradiant';

// Name of the translation file.
const translationFile = 'gradiant.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'gradiant';

// Where can users report bugs.
const bugReport = 'https://mocla.us';

// Last translator Email ID.
const lastTranslator = 'Leandro <leandro@mocla.us>';

// Team's Email ID.
const team = 'Leandro <leandro@mocla.us>';

// Browsers you care about for auto-prefixing. Browserlist https://github.com/ai/browserslist
// The following list is set as per WordPress requirements. Though; Feel free to change.
const BROWSERS_LIST = ['last 15 versions', '> 1%', 'ie 8', 'ie 7'];
...
module.exports = {
  ...
  imgDST,
  watchStyles,
  watchCompomentStyles,
	componentStyleDestination,
  watchJsVendor,
  watchJsCustom,
  watchPhp,
  zipName,
